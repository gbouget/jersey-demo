...
public class ClientServiceTest {
	...
	public void ajouterClient() {
		try {
			...
			final Client clientRecuperer = clientService.recuperer(id);
	...
	public void modifierClient() {
		try {
			...
			final Client clientAModifier = clientService.recuperer(id);
			clientAModifier.setNom("DURAND");
			
			clientService.modifier(clientAModifier);
			
			final Client clientModifie = clientService.recuperer(id);
			assertNotEquals(clientModifie.getNom(), client.getNom());
